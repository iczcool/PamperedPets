	...
	<table style="width:100%">
	  <tr>
	  	...
	  	<td class="main" style="background: transparent; width: 84%; min-height: 100%">
	  		<h2 style="text-align: center;">Ocean Explosion® Treats</h2>
				...
				<ul>
					...
					<li class="description">
						<div>
							...
							<p>
								Shipping weight 59g: 	<br/>
								Units in stock:	6<br/>
								Brand: MEOW MIX
							</p>
							<p>Treat your cat to this tasty medley made with real tuna ocean fish and salmon. Ocean Explosion® treats are also designed to help control tartar and support your cat's oral health!</p>
						</div>
						<div class="buy-now">
