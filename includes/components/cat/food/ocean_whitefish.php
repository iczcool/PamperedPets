	...
	<table style="width:100%">
	  <tr>
	  	...
	  	<td class="main" style="background: transparent; width: 84%; min-height: 100%">
	  		<h2 style="text-align: center;">Ocean Whitefish & Green Peas</h2>
	  		<div class="cat-products">
				<ul>
					<li>
						<div>
							<img src="img/brand/nature/cats/by-nature-cat-grain-free-ocean-white-fish-peas.png">
						</div>
					</li>
					<li class="description">
						<div>
							...
							<p>Our premium grain free cat food with fish features high-quality proteins and the nutrients cats need to remain active and healthy. The first ingredient is real, deboned ocean whitefish, so you can feed your cat with confidence.</p>
						</div>
						<div class="buy-now">
