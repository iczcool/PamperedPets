	...
	<table style="width:100%">
	  <tr>
	  	...
	  	<td class="main" style="background: transparent; width: 84%; min-height: 100%">
	  		<h2 style="text-align: center;">IAMS™ PROACTIVE HEALTH™ HAIRBALL CHICKEN FLAVOR DAILY TREATS</h2>
				...
				<ul>
					...
					<li class="description">
						<div>
							...
							<p>
								Shipping weight: 3,696 kcal/kg	<br/>
								Units in stock:	10<br/>
								Brand: IAMS™
							</p>
							<p>IAMS™ Hairball Care Daily Treats helps control hairballs while supporting a healthy digestive tract.</p>
						</div>
						<div class="buy-now">
