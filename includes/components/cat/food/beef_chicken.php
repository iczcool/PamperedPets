	...
	<table style="width:100%">
	  <tr>
	  	...
	  	<td class="main" style="background: transparent; width: 84%; min-height: 100%">
	  		<h2 style="text-align: center;">Beef & Chicken Stew</h2>
	  		<div class="cat-products">
				<ul>
					<li>
						<div>
							<img src="img/brand/nature/cats/beef-chicken-stew-lg.png">
						</div>
					</li>
					<li class="description">
						<div>
							...
							<p>
								...
								Units in stock:	8.99<br/>
								Brand: By Nature
							</p>
							<p>Our premium, natural cat food offers up a delicious combination of the high-quality proteins and nutrients your pet needs to remain active and healthy.</p>
						</div>
						<div class="buy-now">
