	...
	<table style="width:100%">
	  <tr>
	  	...
	  	<td class="main" style="background: transparent; width: 84%; min-height: 100%">
	  		<h2 style="text-align: center;">Wild Cod Twist</h2>
	  		<div class="dog-products">
				<ul>
					<li>
						<div>
							<img src="/Repository/Pampered Pets/v 1.0/img/brand/nature/dog/by-nature-dog-twists-wild-cod.png">
						</div>	
					</li>
					<li class="description">
						<div>
							...
							<p>
								Shipping weight: 98g	<br/>
								Units in stock:	3<br/>
								Brand: By Nature	
							</p>
							<p>Grain free treat giving dogs healthy boost—even between meals!</p>
						</div>
						<div class="buy-now">
