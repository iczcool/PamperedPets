...
<main>
	<table style="width:100%">
	  <tr>
	  	...
	  	<!-- MAIN -->
	  	<td class="main" style=" width: 84%; min-height: 100%">
	  		<h2 style="text-align: center;">Chicken & Lamb Recipe</h2>
	  		<div class="dog-products">
				<ul>
					<li>
						<div>
							<img src="/Repository/Pampered Pets/v 1.0/img/brand/nature/dog/95-chicken-lamb-l.png">
						</div>	
					</li>
					<li class="description">
						<div>
							...
							<p>
								Shipping weight: 369g	<br/>
								Units in stock:	10<br/>
								Brand: By Nature	
							</p>
							<p>Premium grain free dog food packed with protein for your active and healthy dog. This combination of chicken and lamb is so tasty, your dog won’t even notice it’s helping protect their health, too.</p>
						</div>
						<div class="buy-now">
